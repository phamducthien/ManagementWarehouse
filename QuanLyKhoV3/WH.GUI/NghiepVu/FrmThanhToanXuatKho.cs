...
namespace WH.GUI
{
    public partial class FrmThanhToanXuatKho : FrmBase
    {
        public FrmThanhToanXuatKho(string maHoaDon, KHACHHANG nhacungcap)
        {
            InitializeComponent();
            CreateEvent();
            IsSuccess = false;
        ...
        {
            txtNhaCungCap.Text = KhachHang?.TENKHACHHANG;
