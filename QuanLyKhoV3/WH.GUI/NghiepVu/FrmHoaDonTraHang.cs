...
namespace WH.GUI
{
    public partial class FrmHoaDonTraHang : FrmBase
    {
        public FrmHoaDonTraHang(string maHoaDon, KHACHHANG khachhang)
        {
            InitializeComponent();
            CreateEvent();
            IsSuccess = false;
        ...
        public HOADONNHAPXUAT HoaDon { get; set; }
        public List<HOADONNHAPXUATCHITIET> LstHoadonxuatkhochitiets { get; set; }
        public List<MATHANG> LstMathangs { get; set; }
        public string MaHoaDon { get; set; }

        private IKhachTraHangService XuatKhoService
        {
            get
            {
                ReloadUnitOfWork();
        ...
        private void LoadHoaDon()
        {
            ...
            LstHoadonxuatkhochitiets = (List<HOADONNHAPXUATCHITIET>) HoaDon.HOADONNHAPXUATCHITIETs;
