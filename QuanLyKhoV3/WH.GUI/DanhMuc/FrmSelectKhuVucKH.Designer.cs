namespace WH.GUI
{
	partial class FrmSelectKhuVucKH
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.gbxList.Text = "Danh sách khu vực khách hàng";
			this.gbxList.Values.Description = "Nhấp đúp chuột vào khu vực khách hàng cần chọn";
			this.gbxList.Values.Heading = "Danh sách khu vực khách hàng";
			...
			this.Text = "Chọn Khu Vực Khách Hàng";
