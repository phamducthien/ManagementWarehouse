...
{
    public partial class FrmDonVi : MetroForm
    {
        public FrmDonVi()
        {
            InitializeComponent();
        ...
        private bool SetGuiToData()
        {
            ...
            {
                _baseForm.ShowMessage(IconMessageBox.Warning, "Vui lòng điền thông tin 'Tên Đơn Vị'");
                GetDataFromDgv();
                return false;
            }
