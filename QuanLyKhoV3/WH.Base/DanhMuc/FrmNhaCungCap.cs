...
{
    public partial class FrmNhaCungCap : MetroForm
    {
        ...
        private void ActionSearchData()
        {
            ...
            INHACUNGCAPService service = new NHACUNGCAPService(_baseForm.UnitOfWorkAsync);
            List<NHACUNGCAP> list = service.Search(textSearch);
            LoadData(list);
        }
        ...
        {
            txtTen.Text = _model.TENNHACUNGCAP;
            txtDiaChi.Text = _model.DIACHI;
            txtDiaThoai.Text = _model.DIENTHOAI;
            txtDiDong.Text = _model.DIDONG;
            txtDaiDien.Text = _model.NGUOIDAIDIEN;
        ...
        private bool SetGuiToData()
        {
            ...
            {
                _baseForm.ShowMessage(IconMessageBox.Warning, "Vui lòng điền thông tin 'Tên NCC'");
                GetDataFromDgv();
                return false;
            }
            ...
            _baseForm.ReloadUnitOfWork();
            INHACUNGCAPService service = new NHACUNGCAPService(_baseForm.UnitOfWorkAsync);
            _model = _model == null ? service.CreateNew() : service.Find(_model.IDUnit);
            //Input values to object
            _model.TENNHACUNGCAP = txtTen.Text;
